...
export default function PurchaseOutstanding() {
  ...
  const exportToExcel = () => {
    ...
    XLSX.writeFile(wb, `Purchase_Outstanding_${new Date().toISOString().split('T')[0]}.xlsx`);
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Purchase Outstanding</h1>
      ...
      <main className="container mx-auto px-4 py-4">
        {allInvoices.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-lg border">
            <p className="text-gray-600 mb-4">No pending purchase invoices</p>
              ...
              <tbody className="divide-y divide-gray-100">
                {allInvoices.map((invoice, idx) => (
                  <tr key={invoice.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-3 py-2.5">
                      <Link
                        to={`/party/purchase/${encodeURIComponent(invoice.partyName)}`}
      ...
      <Link to="/add-purchase-invoice">
        <button
          className={`fixed bottom-6 right-6 bg-red-600 hover:bg-red-700 text-white rounded-full shadow-lg transition-all duration-300 flex items-center gap-2 z-50 ${
